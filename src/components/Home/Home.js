...
<div class="page">
  <div class="body">
    ...
    <ul class="blog">
      ...
      <li>
        <div>
          <a href="blog.html"><img src={require('./mono.gif')} /></a>
        <h2>PETE</h2>
      ...
      <li>
        <div>
          <a href="blog.html"><img src={require('./pete.gif')} /></a>
        <h2>DATA</h2>
          <a href="blog.html">Click to read more</a>
        </div>
      </li>
      <li>
        <div>
          <a href="blog.html"><img src={require('./chimp.gif')} /></a>
        <h2>CHEPE</h2>
